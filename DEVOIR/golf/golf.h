...
#define FICHIER_SCORE "/home/USERS/ELEVES/SNIR2017/golf/scores.bin"
#define FICHIER_PARCOURS "/home/USERS/ELEVES/SNIR2017/golf/parcoursGolf.bin"
...
typedef enum
{
    CONDOR=-4, ALBATROS, EAGLE, BIRDIE, PAR, BOGEY, DOUBLE_BOGEY, TRIPLE_BOGEY
}enumPoint;
...
typedef struct{
	char nom[NBMAXCAR];
	int nbTrou;
	//int listeTrous[NBMAXTROU];                               // declaration int ?
...
void afficherMenu(int nbTrou);
int tab[NBMAXPARCOURS][NBMAXPARCOURS];
