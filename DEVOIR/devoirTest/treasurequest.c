...
void afficherMenu(typePersonnage *j1, typePersonnage *j2) {
    if (j1 == NULL) {
        printf(" 1 - Creer personnage joueur 1\n");
    }
    if (j2 == NULL) {
        printf(" 2 - Creer personnage joueur 2\n");
    }
    if (j1 != NULL && j2 != NULL) {
        printf(" 3 - joueur 1 vs joueur 2\n");
        printf(" 4 - joueur 1 vs joueur 2 X10\n");
        printf(" 5 - joueur 2 vs joueur 1\n");
        printf(" 6 - joueur 2 vs joueur 1 X10\n");
        printf(" 7 - Afficher joueur 1\n");
        printf(" 8 - Afficher joueur 2\n");
    }
...
void faireUnDuel(typePersonnage *j1, typePersonnage *j2) {
    ...
    //exp = calculerGainExperience(j2,j1,j2gagne,tour);
    //mettreAJourNiveau(j2,exp);
    printf(BLANC);
    printf("+++++++++++++++++++++++++++++++++++\n");
